...
book_2 = Book("The Great Gatsby", "F. Scott Fitzgerald", 700, "555-5-7820-1162-3")
book_3 = Book("Uncle Tom's Cabin", "Harriet Elizabeth Beecher Stowe", 515, "118-5-7320-8262-3")
book_4 = Book("Dead Souls", "Nikolai Gogol", 850, "901-5-4420-1162-3", True)
book_5 = Book("Anna Karenina", "Leo Tolstoy", 900, "888-5-7120-1162-3")
